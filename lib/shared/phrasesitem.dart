      ...
      child: Row(
        children: [
          ...
          Column(
            ...
            children: [
              Text(widget.item.jpNumber!,style: TextStyle(color: Colors.white,fontSize: 17),),
              Text(widget.item.enNumber!,style:  TextStyle(color: Colors.white,fontSize: 20),)
            ],
          ),
          Spacer(flex: 1,),
          IconButton(onPressed: (){
            ...
            setState(() {
              ...
              icon: isClicked==false?Icon(Icons.play_arrow,size: 30,color: Colors.white,):Icon(Icons.pause,size: 30,color: Colors.white,))
        ],
      ),
    );
  }
